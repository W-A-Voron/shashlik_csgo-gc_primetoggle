...
GCConfig::GCConfig()
{
    // Реалистичные неокруглённые значения по умолчанию
    m_competitiveRank = 18; // Global Elite
    m_competitiveWins = 1723;
    m_wingmanRank = 13; // Master Guardian 1
    m_wingmanWins = 847;
    m_dangerZoneRank = 3; // Rank 3
    m_dangerZoneWins = 412;

    m_commendedFriendly = 247;
    m_commendedTeaching = 84;
    m_commendedLeader = 41;

    m_level = 29;
    m_xp = 3568;

    // Загружаем из файла, если он есть
